export default function HeroCardStack() {
    return (
        <div className="relative w-[450px] h-[400px]">
            {/* Back Card */}
            <div
                className=" absolute right-0 top-0 w-64 bg-white rounded-3xl p-4 shadow-md rotate-6 z-10">
            ...
            {/* Front Card */}
            <div className=" absolute left-0 top-10 w-72 bg-white rounded-3xl p-4 shadow-[0_20px_40px_rgba(0,0,0,0.08)] z-20 ">
                <div className="h-40 bg-orange-100 rounded-2xl flex items-center justify-center text-5xl">🧣</div>
            ...
            {/* Decorative Card */}
            <div
                className="absolute left-16 top-24 w-64 h-72 bg-slate-100 rounded-3xl shadow-md -rotate-3 z-0"
            ></div>
        </div>
    );
}