            ...
            <div className='border-b-2'>
                <nav className="navbar flex mt-4 pl-4 font-serif">
                    ...
                    <ul className="hidden md:flex items-center gap-8 ml-10 list-none text-xl">
                        <li><a href="/" className="text-[#6B5F4E] hover:text-[#1E1A14] font-medium transition-colors">Catalog</a></li>
                        <li><a href="/dashboard" className="text-[#6B5F4E] hover:text-[#1E1A14] font-medium transition-colors">How it Works</a></li>
                        <li><a href="/about" className="text-[#6B5F4E] hover:text-[#1E1A14] font-medium transition-colors">About</a></li>
                    </ul>

                    {/* Right side */}
                    <div className="flex items-center gap-4 ml-auto items-center mr-4">
                        <div className='hidden md:flex items-center gap-2'>
                            <a href="/login" className='border border-2 rounded-lg p-2 mr-3 px-6'>Admin login</a>
                            <a href="/catalog" className='Browse border border-2 rounded-lg p-2 mr-3 bg-[#2c3e6b] text-white px-6'>Browse Crafts</a>
                        </div>
                ...
                {menuOpen && (
                    <div className="md:hidden bg-[#FDFAF5] border-t border-[#DDD3C4] px-6 py-4 flex flex-col gap-4 text-lg">
                        ...
                        <div className="flex flex-col gap-2 pt-2">
                            <a href="/login" className="border-2 border-[#DDD3C4] rounded-lg px-5 py-2.5 font-semibold text-center">Admin Login</a>
